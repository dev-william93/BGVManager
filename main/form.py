...
class EmployeeForm(forms.ModelForm):
    class Meta:
        ...
        labels = {'passport': 'Passport Number', 'address': 'Present Address From To', 'form16_file': 'Form 16', 'aadhar_file': 'Aadhar Number', 'employment_file': 'Employment', 'education_file': 'Education'}
        widgets = {
